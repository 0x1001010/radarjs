            ...
            B = Date.now(), P = B - q, q = B,
                    ...
                    for (be.globalAlpha = 1, be.fillStyle = "rgba(0, 0, 70, 0.35)", be.fillRect(0, 0, oe, ce), be.strokeStyle = rt, a = 0; a < W.length + Y.length; ++a)
                       if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ ==
						...
						var w = (_.team ? "〖" + _.team + "〗" : "") + (_.isPlayer&&_.sid? "༺ " : "") + (_.name + " ༻"|| "");
                            ...
                            var cord1234 = ("Cord: " + Math.round(_.x) + "/" + Math.round(_.y));
                ...
                var color = '#' + r1213.toString(16) + g1213.toString(16) + b1213.toString(16);
                           (be.textAlign = "center",
                            ...
                            be.lineWidth = 6,
                            be.strokeText(HP1234 ,_.x - f,_.y - d + _.scale + o.nameY+(34)),
                            be.fillText(HP1234 ,_.x - f,_.y - d + _.scale + o.nameY+(34))
                            )
                            if(R.isPlayer) {
                            be.textAlign = "center",
                            be.fillStyle = "#cc5500",
                            ...
                            be.strokeStyle = "black",
                            be.lineWidth = 6,
                            be.strokeText(cord1234 ,_.x - f,_.y - d + _.scale + o.nameY+(60)),
                            be.fillText(cord1234 ,_.x - f,_.y - d + _.scale + o.nameY+(60))
                            };
                            if(R) {
                           // be.textAlign = "center",
                           // be.fillStyle = "#cc5500",
